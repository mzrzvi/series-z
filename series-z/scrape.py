...
def get_companies_by_city(city_id, page) :
    ...
    def clean_data(data) :
        ...
        company_data = {
                        ...
                        'thumb_url': data['thumb_url'] if data['thumb_url']  else '',
                        'twitter_url': data['twitter_url'] if data['twitter_url']  else '',
                        'blog_url': data['blog_url'] if data['blog_url']  else '',
                        'video_url': data['video_url'] if data['video_url']  else '',
                ...
                try :
                    if not session.query(exists().where(Startup.name == c['name'])).scalar() :
                        ...
                        company = Startup(c['name'], c['location'], c['popularity'],
                                          ...
                                          c['company_url'], c['logo_url'], c['thumb_url'],
                                          c['twitter_url'], c['blog_url'], c['video_url'], city = city)
